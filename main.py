...
CLANKI_JS = os.path.abspath("clanki/build/index.js")
...
async def setup_tools():
    ...
    return client, [*local_tools, *tools]
...
async def build_graph():
    ...
    client, tools = await setup_tools()
...
async def main():
    ...
    user_prompt = "Please get 10 easy words in German, translate them to English, and create a new Anki deck with them called German::Easy."
